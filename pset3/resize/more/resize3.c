...
int main(int argc, char *argv[])
{
    ...
    else
    {
        ...
        bi.biWidth = bi.biWidth / r;
        bi.biHeight = bi.biHeight / r;
        ...
        for (int i = 0; i < b / r; i++)
        {
            ...
            for (int j = 0  ; j < a/r; j++)
            {
                ...
                fseek(inptr , (r - 1) * sizeof(RGBTRIPLE),SEEK_CUR);
            ...
            fseek(inptr , (a * sizeof(RGBTRIPLE)+paddingold)*(r-1) , SEEK_CUR);
        }
    }
    // close infile
    fclose(inptr);
